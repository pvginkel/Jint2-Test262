...
{
    [TestFixture]
    public class _11_9_5Fixture : Test262Fixture
    {
        public _11_9_5Fixture()
            : base("ch11\\11.9\\11.9.5")
        {
        }
        ...
        [Test(Description = "Checking undeclarated variables")]
        ...
        [Test(Description = "Checking such x and y that either x or y is primitive string and the other is primitive number")]
