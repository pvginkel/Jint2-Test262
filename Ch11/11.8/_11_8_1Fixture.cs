...
{
    [TestFixture]
    public class _11_8_1Fixture : Test262Fixture
    {
        public _11_8_1Fixture()
            : base("ch11\\11.8\\11.8.1")
        {
        }
        ...
        [Test(Description = "Type(Primitive(x)) is different from Type(Primitive(y)) and both types are Number (primitive or object) or Boolean (primitive and object)")]
