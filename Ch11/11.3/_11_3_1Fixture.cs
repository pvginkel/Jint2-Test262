...
{
    [TestFixture]
    public class _11_3_1Fixture : Test262Fixture
    {
        public _11_3_1Fixture()
            : base("ch11\\11.3\\11.3.1")
        {
        }

        [Test(Description = "Strict Mode - SyntaxError is thrown if the identifier 'arguments' appear as a PostfixExpression(arguments++)")]
        public void _11_3_1_2_1_s()
        {
            RunFile("11.3.1-2-1-s.js");
        }

        [Test(Description = "Strict Mode - SyntaxError is throw if the identifier arguments appear as a PostfixExpression(arguments++)")]
        [ExpectedException]
        public void _11_3_1_2_1gs()
        {
            RunFile("11.3.1-2-1gs.js");
        }

        [Test(Description = "Strict Mode - SyntaxError is thrown if the identifier 'eval' appear as a PostfixExpression(eval++)")]
        public void _11_3_1_2_2_s()
        {
            RunFile("11.3.1-2-2-s.js");
        }
        ...
        public void _11_3_1_2_3_s()
        {
            RunFile("11.3.1-2-3-s.js");
        }
        ...
        {
            RunFile("S11.3.1_A1.1_T1.js");
        }

        [Test(Description = "Carriage Return")]
        [ExpectedException]
        public void S11_3_1_A1_1_T2()
        {
            RunFile("S11.3.1_A1.1_T2.js");
        }

        [Test(Description = "Checking Line Seprator")]
        [ExpectedException]
        public void S11_3_1_A1_1_T3()
        {
            RunFile("S11.3.1_A1.1_T3.js");
        }

        [Test(Description = "Checking Paragraph separator")]
        [ExpectedException]
        public void S11_3_1_A1_1_T4()
        {
            RunFile("S11.3.1_A1.1_T4.js");
        }
