...
{
    [TestFixture]
    public class _11_6_2Fixture : Test262Fixture
    {
        public _11_6_2Fixture()
            : base("ch11\\11.6\\11.6.2")
        {
        }
        ...
        [Test(Description = "The difference of two infinities of opposite sign is the infinity of minuend sign")]
        public void S11_6_2_A4_T2()
        {
            RunFile("S11.6.2_A4_T2.js");
        }

        [Test(Description = "The difference of two infinities of the same sign is NaN")]
        public void S11_6_2_A4_T3()
        {
            RunFile("S11.6.2_A4_T3.js");
        }

        [Test(Description = "The difference of an infinity and a finite value is equal to infinity of appropriate sign")]
        public void S11_6_2_A4_T4()
        {
            RunFile("S11.6.2_A4_T4.js");
        }

        [Test(Description = "Using the rule of sum of two zeroes and the fact that a - b = a + (-b)")]
        public void S11_6_2_A4_T5()
        {
            RunFile("S11.6.2_A4_T5.js");
        }

        [Test(Description = "Using the rule of sum of a zero and a nonzero finite value and the fact that a - b = a + (-b)")]
        public void S11_6_2_A4_T6()
        {
            RunFile("S11.6.2_A4_T6.js");
        }

        [Test(Description = "The mathematical difference of two nonzero finite values of the same magnitude and same sign is +0")]
